...
def test_project_metadata():
    assert PROJECT_TYPE == 'Multi-Agent AI'
    assert PROJECT_SUBJECT == 'Research Team Workspace with Analyst, Reviewer, React UI, PostgreSQL, and Docker'
...
def test_pipeline_returns_answer_sources_and_steps():
    ...
    assert result.steps
    assert result.project_type == 'Multi-Agent AI'
